...
export class CreatTicketPopupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.ticketID !== undefined) {
      ...
      console.log(
        this.submitterTeam + ',' + this.reporter + ',' + this.submitterName
      );
  ...
  submiCreate() {
    ...
    this.groupService.getData().subscribe((data) => {
      ...
      data.map((el) =>
        el.requestTypes
          .filter(
            (x) => x.id === this.createTicketDTOFormGroup.value.ticketType
          )
          .map((el) => {
            this.type = {
              id: el.id,
      ...
      this.createTicketDTO.summary =
        this.createTicketDTOFormGroup.value.summary;
  ...
  submitUpdate() {
    ...
    this.groupService.getData().subscribe((data) => {
      ...
      this.updateTicketDto.requestTypeId =
