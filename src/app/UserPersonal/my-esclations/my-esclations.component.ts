...
@Component({
  selector: 'app-my-esclations',
  templateUrl: './my-esclations.component.html',
  styleUrls: ['./my-esclations.component.css']
})
export class MyEsclationsComponent implements OnInit {
empty: boolean = false;
    ...
    this.service.getValue().subscribe((value) => {
      this.flag = value;
        ...
        this.http.POST('Ticket/List', { pageSize: 10, filter: {
            submitterName:this.userName,State: 5} }).subscribe((res) => {
