...
@Component({
  selector: 'app-set-visible-confirmation',
  templateUrl: './set-visible-confirmation.component.html',
  styleUrls: ['./set-visible-confirmation.component.css']
})
export class SetVisibleConfirmationComponent implements OnInit {
...
createloader:any=false;
  ...
  constructor(private http: HTTPMainServiceService,
    public dialogRef: MatDialogRef<SetVisibleConfirmationComponent>,
