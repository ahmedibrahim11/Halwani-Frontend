...
editorConfig: AngularEditorConfig = {
  ...
  constructor(    public dialogRef: MatDialogRef<ReportABugComponent>, private formBuilder: FormBuilder, private http: HTTPMainServiceService, private _snackBar: MatSnackBar,) { }
...
reportaBug()
{
  ...
  this.dialogRef.close();
   this.http.PUT('UserRequest/ReportBug',{text:this.createReport.value.text}).subscribe((res) => {
